...
public class DashboardViewTest extends View {
    ...
    public DashboardViewTest(Context context) {
        this(context, null);
    }

    public DashboardViewTest(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DashboardViewTest(Context context, AttributeSet attrs, int defStyleAttr) {
